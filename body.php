...
<p><i class="far fa-clock"></i>Business hours:   Monday to Sunday  |   9:00am to 9:00pm</p>
  ...
  <a class="nav-link " href="#" id="navbardrop" data-toggle="dropdown" data-hover="dropdown" title="click to open or close map" style=" text-decoration: underline;color:white;margin-left:-12px;margin-top:10px"><i class="fas fa-globe" style="margin-left:-1px"></i>Click to see map</a>   
