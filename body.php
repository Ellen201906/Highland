...
<body>
  ...
  <div class="container" id="body1" style="font-size:20px;margin-top:-15px:margin-left:30px;color:black">
  ...
  <i class="fas fa-envelope-square"></i><a href="Mailto:liuye5@hotmail.com?&Subject=From Highland's customer" style=" text-decoration: underline;;color:black;margin-left:5px">Email to me</a>
  <a class="nav-link " href="#" id="navbardrop" data-toggle="dropdown" data-hover="dropdown" title="click to open or close map" style=" text-decoration: underline;color:black;margin-left:-10px;margin-top:10px"><i class="fas fa-globe"></i>Click to see map</a>   
