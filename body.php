...
<body>
  ...
  <div id="body1" style="font-size:20px;margin-top:-15px">
  ...
  <p><i class="fas fa-phone-volume"></i> Phone number: 780-328-3069</p>
   ...
   <i class="fas fa-envelope-square"></i><a href="Mailto:liuye5@hotmail.com?&Subject=From Highland's customer" style="margin-left:5px;color:black; text-decoration: underline;">Email to me</a>
   
  <p style="margin-top:16px"><i class="fas fa-compass"></i> Address: 8204 Jasper Ave NW, Edmonton AB T5H 3S2</p>
  
  <a class="nav-link " href="#" id="navbardrop" data-toggle="dropdown" data-hover="dropdown" title="click to open or close map" style="margin-left:-10px;color:black; text-decoration: underline;"><i class="fas fa-globe"></i>Click to see map</a>   
 ...
 <p style="margin-top:16px"><i class="fas fa-building"></i>store pictures(below)</p>
